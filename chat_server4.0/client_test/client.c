...
//    int n;
   ...
   /* while (1)
	...
	json_object_object_add(obj,"user_id",json_object_new_string("花子"));
//	json_object_object_add(obj,"user_name",json_object_new_string("李信"));
	json_object_object_add(obj,"user_password",json_object_new_string("123456"));
//	json_object_object_add(obj,"send_user_id",json_object_new_string("韩立"));	
